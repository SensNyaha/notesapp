...
export function RichTextEditor({
  ...
  const changed = () => {
    ...
    if (root) {
      remember();
      onChange(
        sanitizeNoteHtml(root.innerHTML),
  ...
  const addTable = () =>
    apply(
      "insertHTML",
      "<table><tbody><tr><th>Заголовок</th><th>Заголовок</th></tr><tr><td>Ячейка</td><td>Ячейка</td></tr></tbody></table><p><br></p>",
    );
  ...
  return e(
    ...
    e(
      ...
      e(
        "select",
        {
          ...
          onChange: (ev: Event) =>
            apply("formatBlock", (ev.target as HTMLSelectElement).value),
        },
        e("option", { value: "p" }, "Обычный"),
        e("option", { value: "h1" }, "Заголовок 1"),
        e("option", { value: "h2" }, "Заголовок 2"),
        e("option", { value: "blockquote" }, "Цитата"),
        e("option", { value: "pre" }, "Код"),
      ),
      e(
        "select",
        {
          ...
          onMouseDown: remember,
          onChange: (ev: Event) =>
            apply("fontName", (ev.target as HTMLSelectElement).value),
        },
        e("option", { value: "-apple-system" }, "Системный"),
        e("option", { value: "Arial" }, "Arial"),
        e("option", { value: "Georgia" }, "Georgia"),
        e("option", { value: "monospace" }, "Моноширинный"),
      ),
      e(
        "select",
        {
          ...
          onMouseDown: remember,
          onChange: (ev: Event) =>
            apply("fontSize", (ev.target as HTMLSelectElement).value),
        },
        e("option", { value: "3" }, "Обычный"),
        e("option", { value: "2" }, "Мелкий"),
        e("option", { value: "4" }, "Крупный"),
        e("option", { value: "5" }, "Очень крупный"),
      ),
      e(
        "button",
        {
    ...
    e("div", {
      ...
      onBlur: (event: FocusEvent) => {
        remember();
        const next = event.relatedTarget as Node | null;
        if (!next || !toolbar.current?.contains(next)) setEditing(false);
      },
      onPaste: paste,
      ...
      onKeyDown: (ev: KeyboardEvent) => {
        if ((ev.ctrlKey || ev.metaKey) && ev.shiftKey && ev.key === "7") {
          ev.preventDefault();
