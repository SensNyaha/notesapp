  ...
  if(screen==='project'){
    ...
    return e('main',{class:'projects-screen'},
      e(PageHeader,{eyebrow:selectedProject?'Проект':'Системная группа',title:currentProjectName,
        ...
        actions:e('button',{class:'tertiary-button project-refresh-action',disabled:busy,onClick:()=>void load()},e(UiIcon,{name:'sync',size:17}),e('span',null,'Обновить'))}),
      ...
      e('div',{class:'projects-mobile-toolbar'},
        e('details',{class:'projects-mobile-filter-menu'},
          ...
          e('div',{class:'projects-mobile-panel'},
            e('label',{class:'search-field'},e('span',null,'Поиск'),e('input',{type:'search',value:query,placeholder:'Название или описание',onInput:(ev:Event)=>setQuery((ev.target as HTMLInputElement).value)})),
            e('label',{class:'sort-control'},e('span',null,'Показывать'),e('select',{value:projectFilter,onChange:(ev:Event)=>setProjectFilter((ev.target as HTMLSelectElement).value as ProjectFilter)},
