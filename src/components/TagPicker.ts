...
export function TagPicker({tags,selectedIds,onChange,onManage,mode='popover',placement='below',label='Показать теги',showIcon=true,heading,layout='default'}:{
  ...
  return e('div',{class:'unified-tag-control'+(layout==='editor'?' note-edit-tags':'')},
    ...
    e('details',{class:`unified-tag-picker ${mode} ${placement}`},
      e('summary',{class:'secondary-button'},showIcon&&e(UiIcon,{name:'tag',size:17}),e('span',null,label),selected.length>0&&e('span',{class:'filter-count'},String(selected.length))),
      e('div',{class:'unified-tag-panel'},
        ...
        e('div',{class:'unified-tag-options'},visible.map(tag=>e('label',{class:'unified-tag-option',key:tag.id},
