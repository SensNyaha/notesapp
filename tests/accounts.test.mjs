...
test('schema 2 backup migrates to current schema preserving admin, installation and access; restored copy remains schema 2', async t => {
  ...
  f.db.exec('DROP TABLE vault_grants; DROP TABLE vault_challenges; DROP TABLE vault_closures; DROP TABLE records; DROP TABLE vaults; ALTER TABLE users DROP COLUMN must_change_password; ALTER TABLE users DROP COLUMN temporary_expires; ALTER TABLE users DROP COLUMN credential_version; PRAGMA user_version=2;');
